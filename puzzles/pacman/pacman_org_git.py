...
# Audio
from config import MUSIC as MUSIC
from config import PACMAN_BG_AUDIO as BG_AUDIO
...
class Game:
    ...
    def game_play(self):
        ...
        # Stop playing Menu Background Music (Fade out)
        def stop_music():
            # Fade out if there is music playing
            if self.playing:
                mixer.music.fadeout(800)
                self.playing = False

        def start_music():
            # Check if Music enabled in config file
            if MUSIC:
                # Play music when not already playing
                if not self.playing:
                    mixer.music.play(fade_ms=5000, loops=-1)
                    self.playing = True
                ...
                for column in range(len(level[row])):  # j
                    ...
                    if level[row][column] == 1:
                        ...
                        pygame.draw.circle(screen, small_dot_color,
                                        (column * tile_width + (0.5 * tile_width),
                                            row * tile_height + (0.5 * tile_height)),
                                        4)
                    ...
                    if level[row][column] == 5:
                        ...
                        pygame.draw.arc(screen, line_color,
                                        ...
                                        [(column * tile_width - (0.4 * tile_width)-2),
                                        (row * tile_height + (0.5 * tile_height)+1),
                                        tile_width, tile_height], 0, PI/2,
                                        3)
                    ...
                    if level[row][column] == 6:
                        ...
                        pygame.draw.arc(screen, line_color,
                                        # Little tweaked for better aligning
                                        [(column * tile_width + (0.5 * tile_width)+1),
                                        (row * tile_height + (0.5 * tile_height)+1),
                                        tile_width, tile_height], PI/2, PI,
                                        3)
                    ...
                    if level[row][column] == 7:
                        ...
                        pygame.draw.arc(screen, line_color,
                                        # Little tweaked for better aligning
                                        [(column * tile_width + (0.4 * tile_width)+4),
                                        (row * tile_height - (0.4 * tile_height)-2),
                                        tile_width, tile_height], PI, 3 * PI/2,
                                        3)
                    ...
                    if level[row][column] == 8:
                        ...
                        pygame.draw.arc(screen, line_color,
                                        ...
                                        [(column * tile_width - (0.4 * tile_width)-2),
                                        (row * tile_height - (0.4 * tile_height)-2),
                                        tile_width, tile_height], 3 * PI/2, 2 * PI,
                                        3)
        ...
        def check_position(center_x, center_y):
            ...
            if center_x // 30 < 29:
                ...
                if player_direction == 0:
                    ...
                    if level[center_y // tile_height][(center_x - player_offset) //
                                                    tile_width] < 3:
                        # Turns (0 = RIGHT, 1 = LEFT, 2 = UP, 3 = DOWN)
                        turns[1] = True
                ...
                if player_direction == 2:
                    # level[row][column] < 3 (1. Small dot, 2. Big dot (power up))
                    if level[(center_y + player_offset) //
                            tile_height][center_x // tile_width] < 3:
                        # Turns (0 = RIGHT, 1 = LEFT, 2 = UP, 3 = DOWN)
                        turns[3] = True
                ...
                if player_direction == 2 or player_direction == 3:
                    ...
                    if 12 <= center_y % tile_height <= 18:
                        # If tile below is open then enable player_direction DOWN
                        if level[center_y // tile_height][(center_x - tile_width) //
                                                        tile_width] < 3:
                            turns[1] = True
                        # If tile above is open then enable player_direction UP
                        if level[center_y // tile_height][(center_x + tile_width) //
