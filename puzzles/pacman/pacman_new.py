    ...
    def game_play(self):
        ...
        class Ghost:
            ...
            def check_collisions(self):
                tile_height = ((game_height - 50) // 32)  # num1
                tile_width = (game_width // 30)  # num2
                ghost_offset = 15
                ...
                if 0 < self.center_x // 30 < 29:
                    ...
                    if level[(self.center_y - ghost_offset) // tile_height][self.center_x // tile_width] == 9:
                        self.turns[2] = True
                    ...
                    if level[self.center_y // tile_height][(self.center_x - ghost_offset) // tile_width] < 3 \
                            or (level[self.center_y // tile_height][(self.center_x - ghost_offset) // tile_width] == 9 and (self.in_box or self.dead)):
                        self.turns[1] = True
                    ...
                    # OR 9 (9. Ghost Door) and Ghost in Box or Dead
                    if level[self.center_y // tile_height][(self.center_x + ghost_offset) // tile_width] < 3 \
                            or (level[self.center_y // tile_height][(self.center_x + ghost_offset) // tile_width] == 9 and (
                    ...
                    # level[row][column] < 3 (0=Empty 1=Small dot, 2=Big dot)
                    # OR 9 (9. Ghost Door) and Ghost in Box or Dead
                    if level[(self.center_y + ghost_offset) // tile_height][(self.center_x // tile_width)] < 3 \
                            or (level[(self.center_y + ghost_offset) // tile_height][(self.center_x // tile_width)] == 9 and (self.in_box or self.dead)):
                        self.turns[3] = True
                    ...
                    if self.direction == 2 or self.direction == 3:
                        ...
                        if 12 <= self.center_x % tile_width <= 18:
                            ...
                            # OR 9 (9. Ghost Door) and Ghost in Box or Dead
                            if level[(self.center_y - ghost_offset) // tile_height][(self.center_x // tile_width)] < 3 \
                                    or (level[(self.center_y - ghost_offset) // tile_height][self.center_x // tile_width] == 9 and (
                                    self.in_box or self.dead)):
                                self.turns[2] = True
                        ...
                        if 12 <= self.center_y % tile_height <= 18:
                            if level[self.center_y // tile_height][(self.center_x - tile_width) // tile_width] < 3 \
                                    or (level[self.center_y // tile_height][(self.center_x - tile_width) // tile_width] == 9 and (self.in_box or self.dead)):
                                self.turns[1] = True
                ...
                for column in range(len(level[row])):  # j
                    ...
                    if level[row][column] == 1:
                        ...
                        pygame.draw.circle(screen, small_dot_color,
                                           (column * tile_width + (0.5 * tile_width), row * tile_height + (0.5 * tile_height)), 4)
                    ...
                    if level[row][column] == 2 and not flicker:
                        ...
                        pygame.draw.circle(screen, big_dot_color,
                                           (column * tile_width + (0.5 * tile_width), row * tile_height + (0.5 * tile_height)), 10)
                    ...
                    if level[row][column] == 3:
                        ...
                        pygame.draw.line(screen, line_color,
                                        ...
                                        (column * tile_width + (0.5 * tile_width), row * tile_height),
                                        # End position of line (centered)
                                        (column * tile_width + (0.5 * tile_width), row * tile_height + tile_height), 3)
                    ...
                    if level[row][column] == 4:
                        ...
                        pygame.draw.line(screen, line_color,
                                        # Start position of line (centered)
                                        (column * tile_width, row * tile_height + (0.5 * tile_height)),
                                        # End position of line (centered)
                                        (column * tile_width + tile_width, row * tile_height + (0.5 * tile_height)), 3)
                    ...
                    if level[row][column] == 5:
                        ...
                        pygame.draw.arc(screen, line_color,
                                        ...
                                        [(column * tile_width - (0.4 * tile_width) - 2), (row * tile_height + (0.5 * tile_height) + 1),
                    ...
                    if level[row][column] == 6:
                        ...
                        pygame.draw.arc(screen, line_color,
                                        # Little tweaked for better aligning
                                        [(column * tile_width + (0.5 * tile_width) + 1), (row * tile_height + (0.5 * tile_height) + 1),
                    ...
                    if level[row][column] == 7:
                        ...
                        pygame.draw.arc(screen, line_color,
                                        # Little tweaked for better aligning
                                        [(column * tile_width + (0.4 * tile_width) + 4), (row * tile_height - (0.4 * tile_height) - 2),
                    ...
                    if level[row][column] == 8:
                        ...
                        pygame.draw.arc(screen, line_color,
                                        # Little tweaked for better aligning
                                        [(column * tile_width - (0.4 * tile_width) - 2), (row * tile_height - (0.4 * tile_height) - 2),
        ...
        def draw_player():
            ...
            if player_direction == 0:
                ...
                screen.blit(pygame.transform.flip(player_images[counter // 5],
                                                True, False), (player_x, player_y))
            elif player_direction == 2:
                screen.blit(pygame.transform.rotate(player_images[counter // 5],
        ...
        while run:
            ...
            player_hitbox = pygame.draw.circle(
